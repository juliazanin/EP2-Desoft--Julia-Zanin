...
questoes= [{'titulo': 'Qual o resultado da operação 57 + 32?',
         ...
         {'titulo': 'Qual desses abaixo não é um planeta do Sistema Solar?',
          'nivel': 'facil',
          'opcoes': {'A': 'Mercúrio', 'B': 'Vênus', 'C': 'Netuno', 'D': 'Sol'},
          'correta': 'B'},
         ...
         {'titulo': 'Em que ano a Segunda Guerra Mundial terminou?',
          'nivel': 'medio',
          'opcoes': {'A': '1943', 'B': '1945', 'C': '1939', 'D': '1947'},
          'correta': 'B'},

         {'titulo': 'Quem foi o primeiro presidente do Brasil?',
          'nivel': 'medio',
          'opcoes': {'A': 'Getúlio Vargas', 'B': 'Dom Pedro II', 'C': 'Deodoro da Fonseca', 'D': 'Juscelino Kubitschek'},
          'correta': 'C'},
         ...
         {'titulo': 'Quantos ossos tem o corpo humano adulto?',
          'nivel': 'dificil',
          'opcoes': {'A': '186', 'B': '300', 'C': '206', 'D': '256'},
          'correta': 'C'},

         {'titulo': 'Qual é a velocidade aproximada da luz no vácuo?',
          'nivel': 'dificil',
          'opcoes': {'A': '150.000 km/s', 'B': '300.000 km/s', 'C': '1.000.000 km/s', 'D': '30.000 km/s'},
          'correta': 'B'}
        ] 